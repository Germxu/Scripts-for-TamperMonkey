...
(function () {
    ...
    window.addEventListener("DOMContentLoaded", function () {
        ...
        $("#FinnBtm").click(function () {
            let h = $("#article_content").height() || $("html").height();
            $("html").animate({ scrollTop: h-250 }, 300);
        });
    })
})();
