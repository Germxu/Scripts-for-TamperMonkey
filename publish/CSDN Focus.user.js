...
(function () {
    ...
    let FinnData = localStorage.FinnData && JSON.parse(localStorage.FinnData) || {};
    ...
    const csdn = `<style>[darkMode]{filter:invert(1) hue-rotate(180deg)}[darkMode] #darkBtn,[darkMode] img,[darkMode] code.hljs,
        ...
        #FinnTop{width:36px;height:36px;color:#ff4d4d;font:600 14px/44px arial;text-align:center;position:fixed;left:50%;margin-left:520px;bottom:80px;z-index:999;cursor:pointer;background:#fff;border-radius:50%;box-shadow:0 0 20px #75757545;}
        #FinnTop:before{content:"";position:absolute;left:28%;top:16%;color:#ff4d4d;width:14px;height:14px;border-top:2px solid #ff4d4d;border-left:2px solid #ff4d4d;transform:rotate(45deg)}
