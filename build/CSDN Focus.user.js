// ==UserScript==
// @name         CSDN Focus
// @description 🌚 黑暗模式上线, 一键换天  |  CSDN,脚本之家无弹窗无广告无推荐阅读, 展开文章和评论, 保留搜索栏, 外链直达! | 受够了脚本注入导致的闪屏重绘页面吗, 试试不一样的感觉吧 😁
// @version      1.5
// @author       Finn
...
//
// @note         V1.5 功能:添加黑暗模式, 一键切换, 优化代码逻辑,
